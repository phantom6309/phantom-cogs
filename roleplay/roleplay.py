...
class Roleplay(BaseCog):
    ...
    @commands.command()
    @commands.bot_has_permissions(embed_links=True)
    async def kucakla(self, ctx, *, user: discord.Member):
        """Bir kullanıcıyı kucaklayın!"""
    ...
    @commands.command()
    @commands.bot_has_permissions(embed_links=True)
    async def öp(self, ctx, *, user: discord.Member):
        """Bir kullanıcıyı öpün!"""
    ...
    @commands.command()
    @commands.bot_has_permissions(embed_links=True)
    async def tokatla(self, ctx, *, user: discord.Member):
        """Birini tokatlayın!"""
    ...
    @commands.command()
    @commands.bot_has_permissions(embed_links=True)
    async def yala(self, ctx, *, user: discord.Member):
        """Birini yalayın!"""
    ...
    @commands.command()
    @commands.bot_has_permissions(embed_links=True)
    async def beşlik(self, ctx, *, user: discord.Member):
        """Birine beşlik çakın!"""
    ...
    @commands.command()
    @commands.bot_has_permissions(embed_links=True)
    async def besle(self, ctx, *, user: discord.Member):
        """Birini besleyin!"""
    ...
    @commands.command()
    @commands.bot_has_permissions(embed_links=True)
    async def gıdıkla(self, ctx, *, user: discord.Member):
        """Birini gıdıklayın!"""
    ...
    @commands.command()
    @commands.bot_has_permissions(embed_links=True)
    async def dürt(self, ctx, *, user: discord.Member):
        """Birini dürtün!"""
    ...
    @commands.command()
    @commands.bot_has_permissions(embed_links=True)
    async def havaat(self, ctx):
        """Biraz hava atma ile kendini beğenmişlik gibi bir şey deneyin görün !"""
